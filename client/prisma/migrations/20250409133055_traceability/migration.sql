...
-- CreateIndex
CREATE UNIQUE INDEX "wallet_nonce_user_id_key" ON "wallet_nonce"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "media_url_key" ON "media"("url");

-- AddForeignKey
ALTER TABLE "wallet_nonce" ADD CONSTRAINT "wallet_nonce_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
