...
import { ITraceAbilityContract } from "../interfaces/itraceability.interface";
import { isEmpty, isNil } from "lodash";
import { getPkHash } from "../utils";

export class TraceAbilityContract extends MeshAdapter implements ITraceAbilityContract {
    /**
     * @method Mint
